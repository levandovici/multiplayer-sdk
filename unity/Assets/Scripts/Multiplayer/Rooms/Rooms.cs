...
namespace Michitai.Multiplayer.Rooms
{
    ...
    /// player management, actions, updates, and administrative operations in Unity.
    /// </summary>
    public class Rooms
    {
        /// <summary>
        ...
        public static Task<RoomListResponse<T>> GetRoomsAsync<T>(Client client, string search = null, int limit = 20, CancellationToken ct = default) where T : class, new()
